...
def pre_process_sysu(data_dir):
    ...
    train_color_image, train_color_label = read_image(files_rgb, pid2label, 144, 288)
    train_thermal_image, train_thermal_label = read_image(files_ir, pid2label, 144, 288)
...
class SYSUData(data.Dataset):
    def __init__(self, data_dir,  transform_train_rgb=None, transform_train_ir=None, colorIndex = None, thermalIndex = None):
        data_dir = '/mnt/c4654b37-10e2-4639-99aa-feb4202457cb/image-1903/wxb/data/SYSU-MM01/'
        # Load training images (path) and labels
        self.train_color_image, self.train_color_label, self.train_thermal_image, self.train_thermal_label = pre_process_sysu(data_dir)

        self.transform_rgb = transform_train_rgb
        self.transform_ir = transform_train_ir
...
class RegDBData(data.Dataset):
    def __init__(self, args, data_dir, transform_train_rgb, transform_train_ir, trial, colorIndex = None, thermalIndex = None):
        # Load training images (path) and labels
        data_dir = '/mnt/c4654b37-10e2-4639-99aa-feb4202457cb/image-1903/wxb/data/RegDB/'
